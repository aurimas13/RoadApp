...
**ids** (*required*) - this is the list of vehicle ids you want to query</br>
**period_start** (*required*) - this is the start date you want to get the average numerical metrics from (format: ```%Y-%m-%d %X```)</br>
